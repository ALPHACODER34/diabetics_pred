...
st.sidebar.header('Please Do Enter Your Data...')
...
# Add your name and designation with CSS for right alignment
st.markdown(
    """
    <div style="position: absolute; bottom: 10px; right: 10px;">
        <p style="font-size: 20px; color: gray;">Made by Rakesh HR</p>
    </div>
    """,
